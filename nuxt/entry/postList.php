...
$sql = "SELECT a.id, a.content, a.reply_num, a.img_list, a.create_tm, b.user_name, b.avator FROM post a INNER JOIN user_info b ON a.topic_id REGEXP '^{$topic_id},|,{$topic_id},|,{$topic_id}$' AND a.user_id = b.uid";
