<template>
  <div class="game-detail-tab game-detail-tab-top" ref="detailTab" @click="changeTab">
    <div class="tab-item active" v-if="currentTab == 0" data-index="0" data-name="movie">最新电影</div>
    <div class="tab-item" v-if="currentTab != 0" data-index="0" data-name="movie">最新电影</div>

    <div class="tab-item active" v-if="currentTab == 1" data-index="1" data-name="movie-coming">即将上映</div>
    <div class="tab-item" v-if="currentTab != 1" data-index="1" data-name="movie-coming">即将上映</div>
